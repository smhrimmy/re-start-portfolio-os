...
export const EditorialButton: React.FC<EditorialButtonProps> = ({
  ...
  const baseStyles =
    'font-mono inline-flex items-center justify-center gap-2 font-bold tracking-wider transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#8B0000] focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed select-none';
